...
urlpatterns = [
    ...
    path('api/dm/analysis/', api.EvaluationAnalysisAPI.as_view(), name='dm-analysis'),
    path('api/dm/accessible-prompts/', api.AccessiblePromptsAPI.as_view(), name='dm-accessible-prompts'),
