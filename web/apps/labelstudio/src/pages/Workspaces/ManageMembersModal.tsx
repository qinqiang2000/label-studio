...
export const ManageMembersModal: React.FC<ManageMembersModalProps> = ({ workspace, onClose, onMembersUpdated }) => {
  ...
  return (
    <Block name="manage-members-modal">
      {successMessage && <Elem name="success-message">{successMessage}</Elem>}
      ...
      <Elem name="section">
        ...
        <Elem name="members-list">
          ...
          {members.length === 0 && <Elem name="empty-state">No members yet</Elem>}
        </Elem>
      </Elem>
