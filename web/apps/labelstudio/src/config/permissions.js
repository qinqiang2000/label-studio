...
export const SIMPLIFIED_PERMISSIONS = {
  ...
  workspace_manage_full: {
    ...
    includes: ['manage_workspaces', 'edit_workspace', 'delete_workspace', 'manage_workspace_members', 
              'show_edit_workspace_button', 'show_delete_workspace_button'],
    group: 'simplified_workspace'
  },
  ...
  user_manage_full: {
    ...
    includes: ['manage_users', 'manage_roles', 'edit_user_role_assignment', 'show_invite_users_button', 'show_manage_user_roles'],
  ...
  project_settings_advanced: {
    ...
    includes: ['view_project_machine_learning', 'view_project_predictions', 'view_project_cloud_storage', 
              'view_project_webhooks', 'edit_project_ml_settings', 'edit_project_webhook_settings'],
    group: 'simplified_project'
  }
};
