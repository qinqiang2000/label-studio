...
export class PermissionAnalyzer {
  ...
  analyzeComplexity() {
    ...
    const buttonPermissions = Object.entries(this.definitions)
  ...
  findUnusedPermissions() {
    ...
    return definedPermissions.filter(permission => 
      !dangerousOperations.includes(permission) &&
      this.definitions[permission].category === 'page_operation'
    );
  }
